...
public class MoonPhase {
    ...
    public String toString() {
        ...
        switch (phase) {
            case 75: ret = "Halbmond (1. Viertel)"; break;
            case 100: ret = "Vollmond (2. Viertel)"; break;
            case 25: ret = "Halbmond (3. Viertel)"; break;
            case 50: ret = "Neumond (4. Viertel)"; break;
            default:
                if (phase < 25) ret = "Abnehmender Mond";
                else if (phase < 50) ret = "Abnehmende Sichel";
                else if (phase < 75) ret = "Zunehmende Sichel";
                else if (phase < 100) ret = "Zunehmender Mond";
        }
